...
export function FilterSelect({
  ...
  return (
    <select
      ...
      aria-label={label}
      className="border-border-strong bg-background text-foreground text-label cursor-pointer appearance-none rounded-lg border py-2 pl-3 pr-[30px] outline-none"
    >
