  ...
  return (
    ...
    >
      <span className="bg-active relative block h-[190px] overflow-hidden">
        ...
        <span className="bg-brand-ink/80 text-pico rounded-pill absolute left-2.5 top-2.5 px-2.5 py-[5px] font-mono font-bold tracking-[0.06em] text-white">
      ...
      <span className="block px-3.5 pb-3.5 pt-3">
        ...
        <span className="text-label mt-1 block overflow-hidden leading-[1.45] [-webkit-box-orient:vertical] [-webkit-line-clamp:2] [display:-webkit-box]">
