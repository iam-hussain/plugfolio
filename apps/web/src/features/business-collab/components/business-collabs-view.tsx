  ...
  return (
    <BusinessChrome>
      ...
      <div className="flex flex-col gap-7">
        ...
        {/* There is no bespoke browse screen and there should not be: vetting a
            creator means reading their public page, which is the same page a
            shopper reads. A brand-only view would be a second version of the
            truth. */}
