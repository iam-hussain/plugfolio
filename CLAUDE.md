...
| Auth | **Auth.js (NextAuth)**; **email + password login, email verified once at registration** (see [ADR-0004](./docs/adr/0004-creator-account-profiles-identity.md), [ADR-0012](./docs/adr/0012-password-login-with-registration-verification.md)) | Creators, shoppers & businesses register with email + password (one verification link; reset by email link); no username is ever a login; a creator **account** connects Google+Meta and holds up to 5 **profiles**, each with a social-derived username; anonymous shoppers stay account-free. |
