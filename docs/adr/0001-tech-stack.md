...
| Auth | Auth.js (NextAuth); **email login for all account holders**; creator accounts connect Google+Meta and hold profiles with social-derived usernames (see ADR-0004); shoppers anonymous by default |
